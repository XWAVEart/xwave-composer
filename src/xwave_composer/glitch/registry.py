...
EFFECTS: tuple[EffectSpec, ...] = (
    ...
    EffectSpec(
        ...
        params=(
            ...
            P("mode", "Color mode", "choice", "xtreme", choices=_c(("xtreme", "Xtreme"), ("subtle", "Subtle"), ("mono", "Mono"))),
    ...
    EffectSpec(
        ...
        params=(
            ...
            P("pattern_width", "Pattern width", "int", 1, min=1, max=100, when={"sorting_method": ("perlin_full_frame",)}),
